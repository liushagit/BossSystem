...
<form action="/bill/index" method="post">
    ...
    开始日期&nbsp;
    <input class="Wdate" name="sdate" style="width: 100px;height:20px;" value="<%=sdf1%>" type="text" id="d15" onFocus="WdatePicker({isShowClear:false,readOnly:true})"/> 
    结束日期&nbsp;
    <input class="Wdate" name="edate" style="width: 100px;height:20px;" value="<%=sdf2%>" type="text" id="d15" onFocus="WdatePicker({isShowClear:false,readOnly:true})"/>
      ...
      <DIV id=turn-page>
		...
		<tr>
                        ...
                        <td width="80%" align=right vAlign="center" noWrap><a
                            ...
                            <a href="/bill/${pages.pageNumber - 1 }">上一页</a>
                            </c:if>
                            ...
                            <c:if test="${pages.pageNumber ne pages.totalPage }">
 							<a href="/bill/${pages.pageNumber +1}">下一页</a>
                            </c:if>
                             <a href="/bill/${pages.totalPage }">尾页</a>
                    </td>
                    </tr>
		</table>   
      </DIV></TD>    
